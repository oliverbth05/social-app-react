...
export default function LikeButton(props) {
  if (props.loading) {
    ...
    return <button onClick={() => { props.likePost({post_id : props.post_id, user_id: props.user_id, token: props.token}) }} className='button m-r-1'><i className="far fa-thumbs-up"></i> Like</button>
  }
}
