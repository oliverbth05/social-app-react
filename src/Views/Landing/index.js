        ...
        <div>
            ...
            <div className = 'container-flex-center bg-white'>
                ...
                <section className = 'p-a-3'>
                    <h2 className = 'p-b-1 text-center m-b-1'>About</h2>
                    <h4 className = 'p-t-1'>Features</h4>
                    <ul>
                    ...
                    <h4 className = 'p-t-1 m-b-1 '><i class="fab fa-github"></i> GitHub</h4>
                ...
                <section className = 'p-a-3'>
                    <h2 className = 'p-b-1  text-center' >Technologies</h2>
                    <div className = 'logo-grid'>
                        <div>
                            <h4 className = 'p-a-1 text-center '>Front-End</h4>
                            <div className = 'logo-flex'>
                        ...
                        <div>
                            <h4 className = 'p-a-1 text-center '>Back-End</h4>
                            <div className = 'logo-flex'>
                        ...
                        <div>
                            <h4 className = 'p-a-1 text-center  '>Development</h4>
                            <div className = 'logo-flex'>
